...
Contributions à l’analyse de survie et à la détection de marqueurs en oncologie (Click here to see the abstract) </summary>
<p>
Résumé : <br>
to complete...
</p>
...
Contributions à l'analyse de survie en oncologie (Click here to see the abstract) </summary>
<p> Résumé : <br>
...
Étude des réseaux de neurones pour prédire la survie en oncologie  (Click here to see the abstract) </summary>
<p>Résumé : <br>
